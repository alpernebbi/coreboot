...
{
	bootmem_add_range(0xf8000000, 0x8000000, BM_MEM_RESERVED);
	/* slows display down but avoids visual artifacts */
	bootmem_add_range((uintptr_t)_framebuffer, REGION_SIZE(framebuffer),
			  BM_MEM_RESERVED);
